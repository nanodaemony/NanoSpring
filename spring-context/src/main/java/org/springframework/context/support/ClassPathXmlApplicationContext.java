...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	/**
	 * 创建一个ClassPathXmlApplicationContext，从XML文件中加载bean Definition并自动刷新context
	 *
	...
	/**
	 * 根据给定的parent context创建一个ClassPathXmlApplicationContext，从XML文件中加载bean Definition并自动刷新context
	 *
	 * @param configLocations 资源路径
	 * @param refresh 是否刷新context，并加载所有的bean definition并为其生成全部的singletons; 也可以在后续的配置中再进行手动刷新context
	 * @param parent 指定的父context
	 * @throws BeansException if context creation failed
	 * @see #refresh()
	 */
